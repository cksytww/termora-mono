...
## 📥 Download Release (v0.0.7)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.7-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.7/Termora-v0.0.7-macOS.dmg)
