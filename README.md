...
## 📥 Download Release (v0.0.10)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.10-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.10/Termora-v0.0.10-macOS.dmg)
